...
namespace ServiceBusRelay.Server
{
    class Program
    {
        ...
        {
            var host = new ServiceHost(typeof(ConsoleService), new Uri("sb://BlueYonderServerDemo09YourInitials.servicebus.windows.net"));
            ...
            {
                TokenProvider = TokenProvider.CreateSharedSecretTokenProvider("owner", "[access_key]")
            });
