...

{
    ...
    If ($20533DlabNumberGlobal) {
        Start-Transcript -Path "D:\Temp\MOC20533\Allfiles\Logs\Remove-20533DEnvironment-$20533DlabNumberGlobal.log" -IncludeInvocationHeader -Append -Force
    } else {
        Start-Transcript -Path "D:\Temp\MOC20533\Allfiles\Logs\Remove-20533DEnvironment-0.log" -IncludeInvocationHeader -Append -Force
    }
