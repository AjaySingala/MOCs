...
using PhotoSharingApplication.Repositories;
...
namespace PhotoSharingApplication.Controllers
{
    public class PhotoController : Controller
    {
        ...
        private IPhotoRepository _repo = new PhotoRepository();
        //
        // GET: /Photo/
        //[SimpleActionFilter]
        //[ResultActionFilter]
        ...
        {
            //throw new Exception("Exception thrown explicitly");

            ViewBag.Message = "This is a message";
            ViewData["Message2"] = "This is another message";
